...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.picture_hash'
        db.add_column('profile_profile', 'picture_hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.picture_hash'
        db.delete_column('profile_profile', 'picture_hash')
